...
exports.types = exports.Reducer = exports.unregisterReducer = exports.registerReducer = exports.getState = exports.dispatch = exports.connectReducers = exports.ssr = void 0;
...
var ReduxStore = /** @class */ (function () {
    function ReduxStore(data) {
        ...
        if (data.length > 0) {
            ...
            this.reducerManager = new ReducerManager_1.default(__assign({ form: redux_form_1.reducer }, reducers));
            this.store = redux_1.createStore(this.reducerManager.reduce, initialState, this.middleware);
        }
        else {
...
var ssr = function (data) {
    ...
    store = storage.store;
    exports.connectReducers = connectReducers = storage.connectReducers;
    exports.dispatch = dispatch = storage.dispatch;
    exports.getState = getState = storage.getState;
    exports.registerReducer = registerReducer = storage.registerReducer;
    exports.unregisterReducer = unregisterReducer = storage.unregisterReducer;
};
exports.ssr = ssr;
