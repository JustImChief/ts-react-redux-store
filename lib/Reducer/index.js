...
var ts_data_transformer_1 = require("ts-data-transformer");
...
var Reducer = /** @class */ (function () {
    function Reducer(initialState) {
        ...
        this.actions = {};
        this.DT = ts_data_transformer_1.default;
        this.DV = ts_data_validator_1.default;
        this.initialData = {};
        this.initialValues = {};
        this.initialState = {
    ...
    Reducer.prototype.ssr = function (initialState) {
        if (initialState === void 0) { initialState = {}; }
        this.initialState = __assign(__assign({}, this.initialState), initialState);
        return this.init();
    };
